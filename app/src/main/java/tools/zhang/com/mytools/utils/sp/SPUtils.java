package tools.zhang.com.mytools.utils.sp;
...
import tools.zhang.com.mytools.storager.SharedPreferencesImpl;
...
public class SPUtils {
    ...
    public static void put(String fileName, Context context, String key, Object object) {
        SharedPreferences sp = SharedPreferencesImpl.getSharedPreferences(context, fileName,
    ...
    public static void setString(String fileName, Context context, String key, String defValue) {
        put(fileName, context, key, defValue);
    }
    ...
    public static void setInt(String fileName, Context context, String key, int defValue) {
        put(fileName, context, key, defValue);
    }
    ...
    public static void setLong(String fileName, Context context, String key, long defValue) {
        put(fileName, context, key, defValue);
    }
    ...
    public static void clear(Context context) {
        SharedPreferences sp = SharedPreferencesImpl.getSharedPreferences(context, FILE_NAME,
                Context.MODE_PRIVATE);
        Editor editor = sp.edit();
        editor.clear();
        editor.apply();
